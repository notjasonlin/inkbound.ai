...
export async function middleware(request: NextRequest) {
  ...
  // Removed https://jtf79lf49l.execute-api.us-east-2.amazonaws.com/fetch-email-data
  ...
  let cspHeader = `
    ...
    connect-src 'self' https://tvjclbhclyozgziixpcp.supabase.co wss://tvjclbhclyozgziixpcp.supabase.co https://api.openai.com https://accounts.google.com https://vitals.vercel-insights.com https://vercel.live/ https://vercel.com https://191gxash54.execute-api.us-east-2.amazonaws.com/email-classifier *.pusher.com *.pusherapp.com;
