...
const Hero: React.FC = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 py-6 md:py-12 lg:px-10 bg-gradient-to-br from-blue-50 to-babyblue-100 space-y-12 md:space-y-16 relative overflow-hidden">
